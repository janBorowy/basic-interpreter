...
class ParserSpec extends Specification {
    ...
    def "Should parse function with return"() {
        given:
        var p = parseProgram("int main() { return 0; return 2 + 2; }")
        expect:
        p == new Program(
                List.of(new FunctionDefinition(
    ...
    def "Should parse function with identifier statement"() {
        var p = parseProgram("int main() { a = 2; hello(); }")
        expect:
        p == new Program(
                    List.of(
                            new FunctionDefinition(
